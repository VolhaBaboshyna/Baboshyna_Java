...
import static by.homework.lessons.Task17.AddTextToFile.addTextToFile1;
import static by.homework.lessons.Task17.AddTextToFile.addTextToFile2;
import static by.homework.lessons.Task17.ReadTextFromFile.readTextFromFile;
...
public class Serialize implements Serializable {
    ...
    public static void main(String[] args) {
        ...
        addTextToFile1(text);
        addTextToFile2(text);
        System.out.println(readTextFromFile("src\\by\\homework\\lessons\\Task17\\Task17.txt"));
        System.out.println(readTextFromFile("D:\\Оля\\java\\Task17.txt"));
    }
